...
MAIN_BIN="${MAIN_BIN:-$ROOT_DIR/Examples/RGB-D/rgbd_tum}"
VOCAB_FILE="${VOCAB_FILE:-$ROOT_DIR/Vocabulary/ORBvoc.txt}"
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT_DIR/output_data/Office}"
...
# Dataset setup.
# Override BONN_PACKAGE_DIR / SETTINGS_FILE / SEQUENCE_BASE_DIR when needed.
BONN_PACKAGE_DIR="${BONN_PACKAGE_DIR:-$ROOT_DIR/input_data}"
SEQUENCE_BASE_DIR="${SEQUENCE_BASE_DIR:-$BONN_PACKAGE_DIR}"
SETTINGS_FILE="${SETTINGS_FILE:-$BONN_PACKAGE_DIR/openloris.yaml}"
